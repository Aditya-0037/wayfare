...
const steps = [
  { n: "01", title: "Discover", body: "Reads NameRegistered logs off wayfare.eth's ENS subregistry. No provider URL is hardcoded anywhere in the agent." },
  { n: "02", title: "Quote", body: "Asks every discovered provider for a live price. Anything that can't handle the input declines at quote time, before payment." },
  { n: "03", title: "Decide", body: "Picks the best affordable option on price and quality, and logs the full reasoning trail — not a black box." },
  { n: "04", title: "Pay & anchor", body: "Settles per call over x402 on Hedera testnet, then anchors provider, price, tx id and result hash to one HCS topic." },
];

export default function HowItWorks() {
  return (
    <section id="how" className="relative border-b border-edge/5 py-24">
